...
gymApp.config(["$stateProvider", "$urlRouterProvider", "localStorageServiceProvider", function ($stateProvider, $urlRouterProvider, localStorageServiceProvider) {

    $urlRouterProvider.otherwise("/");
    $stateProvider.state('newSession', {
        url: '/newSession',
    ...
    localStorageServiceProvider.setPrefix('gymApp').setStorageType('sessionStorage').setNotify(true, true);
...
gymApp.factory('cacheManager', ['$cacheFactory', 'localStorageService', function ($cacheFactory, localStorageService) {
    ...
    var cacheManager = {
        ...
        getIdForNewSession: function getIdForNewSession() {},

        getIdForNewStep: function getIdForNewStep() {},
        ...
        saveSession: function saveSession(newSession) {
        ...
        controller: ['$scope', '$state', 'cacheManager', function ($scope, $stat, cacheManager) {
            ...
            $scope.session.steps.forEach(function (step, i) {
                ...
                $scope.chartSteps.push({
                    ...
                    numberData: [[step.forecastNumbers], [step.actualNumbers]],
                    weightData: [[step.forecastWeight], [step.actualWeight]],
                    timeData: [[totalSecF], [totalSecA]]
                });
    ...
    return {
        ...
        controller: ['$scope', '$state', '$cacheFactory', function ($scope, $stat, $cacheFactory) {
            ...
            $scope.start = function () {
                if ($scope.step.forecastNumbers == 0 && $scope.step.forecastTime == 0 && $scope.step.forecastWeight == 0) {
                    $scope.isError = true;
                } else {
                    $scope.isError = false;
                    var date = new Date();
...
var DataOverTimeObject = function DataOverTimeObject() {
    this.excercise = "";
    this.days = [];
};
